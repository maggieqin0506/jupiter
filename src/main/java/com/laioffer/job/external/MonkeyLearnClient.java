...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "8d9eee27c2c81d903997354974e8ad0891331ad1";

    public List<Set<String>> extract() {
        return extract();
    }
    ...
    public List<Set<String>> extract(List<String> articles) {
        ...
        // convert the response into the right format
        // response --> list of set
        ResponseHandler<List<Set<String>>> responseHandler = response -> {
            ...
            // content string --> corresponding array
            // .class: the target class (class type)
    ...
    public static void main(String[] args) {
        List<String> articles = Arrays.asList("Elon Musk has shared a photo of the spacesuit designed by SpaceX. " +
